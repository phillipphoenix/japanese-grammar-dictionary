import { LanguageCodes } from "../types/api/entry";
 ...
 * @param searchString 
 */
export const anyLocalisationIncludes = (entryPropLocalised: {[language in LanguageCodes]: string}, searchString: string): boolean => {
